    					...
    					<table class="table table-hover">
                            ...
                            <tbody>
								@php 
									$subT = 0; 
								@endphp
                                @foreach($order->details as $Order_item)
								@php 
									$subT = $subT + $Order_item->subtotal;
								@endphp
    							<tr class="border">
    								<td class="text-center">{{$Order_item->id}}</td>
    								<td class="text-center">{{$Order_item->plant->plantname}}</td>
