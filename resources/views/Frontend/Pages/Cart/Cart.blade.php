    ...
    <div class="container mt-5 p-3 rounded cart">
        <div class="row no-gutters">
            ...
            <div class="col-md-4">
                ...
                <a href="{{route('checkout')}}" class="btn btn-primary btn-block d-flex justify-content-between mt-3" type="button"><span>Checkout<i class="fa fa-long-arrow-right ml-1"></i></span></a>
                <br>
            </div>
        </div>
    </div>
